    ...
    <section ref={ref} className="relative min-h-screen flex items-center overflow-hidden">
      <div className="absolute inset-0 z-0 opacity-30">
        <MagicRings color="#3690d2" colorTwo="#5bc4a0" speed={0.5} ringCount={4} attenuation={10}
          lineThickness={1} baseRadius={0.3} radiusStep={0.1} opacity={0.4} noiseAmount={0.06}
          ringGap={1.8} followMouse mouseInfluence={0.1} hoverScale={1.03} parallax={0.03} clickBurst blur={2} />
      </div>
          ...
          <div className="flex-1 max-w-2xl">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-[11px] tracking-wide"
                ...
                <ShinyText text="Live on X Layer  ·  Gas-Free  ·  TEE Secured" speed={3} color="rgba(255,255,255,0.4)" shineColor="#fff" />
              </div>
            </motion.div>
            ...
            <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.55 }}
              className="mt-6 text-lg max-w-lg leading-relaxed" style={{ color: "rgba(255,255,255,0.45)" }}>
              GhostFolio deploys intelligent decoy swaps that make your on-chain footprint unreadable. Watchers see noise. Your alpha stays invisible.
            </motion.p>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.75 }}
              ...
              <StarBorder as="div" color="rgba(54,144,210,0.5)" speed="4s">
                <Link href="/login" className="flex items-center gap-2 px-8 py-4 text-base font-semibold text-white rounded-xl group"
              ...
              <a href="#features" className="px-8 py-4 text-base font-medium rounded-xl transition-all"
          ...
          >
            ...
            >
              ...
              <Card customClass="p-6 cursor-pointer"
                style={{ background: "rgba(20,29,44,0.5)", backdropFilter: "blur(24px)", border: "1px solid rgba(255,255,255,0.1)" } as React.CSSProperties}>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-[10px] uppercase tracking-wider" style={{ color: "rgba(255,255,255,0.4)" }}>Privacy Score</span>
                  <span className="text-[10px] px-2 py-0.5 rounded-full" style={{ background: "rgba(91,196,160,0.15)", color: "#5bc4a0" }}>+12</span>
                </div>
                <div className="text-5xl font-bold text-white mb-2">87<span className="text-xl" style={{ color: "rgba(255,255,255,0.3)" }}>/100</span></div>
                ...
                <div className="text-[10px] mt-2" style={{ color: "rgba(255,255,255,0.3)" }}>Observer accuracy: 13%</div>
              </Card>
              ...
              <Card customClass="p-6 cursor-pointer"
                style={{ background: "rgba(20,29,44,0.5)", backdropFilter: "blur(24px)", border: "1px solid rgba(255,255,255,0.1)" } as React.CSSProperties}>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-[10px] uppercase tracking-wider" style={{ color: "rgba(255,255,255,0.4)" }}>Decoy Swaps</span>
                  <span className="relative w-2 h-2 rounded-full bg-emerald-400 live-dot" />
                </div>
              ...
              <Card customClass="p-6 cursor-pointer"
                style={{ background: "rgba(20,29,44,0.5)", backdropFilter: "blur(24px)", border: "1px solid rgba(255,255,255,0.1)" } as React.CSSProperties}>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-[10px] uppercase tracking-wider" style={{ color: "rgba(255,255,255,0.4)" }}>Surveillance</span>
              ...
              <Card customClass="p-6 cursor-pointer"
                style={{ background: "rgba(20,29,44,0.5)", backdropFilter: "blur(24px)", border: "1px solid rgba(255,255,255,0.1)" } as React.CSSProperties}>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-[10px] uppercase tracking-wider" style={{ color: "rgba(255,255,255,0.4)" }}>Real vs Public</span>
                </div>
                <div className="space-y-3">
                  <div>
                    <div className="text-[9px] mb-1" style={{ color: "rgba(255,255,255,0.3)" }}>Your real allocation</div>
                    ...
                    <div className="flex gap-3 mt-1.5 text-[8px]" style={{ color: "rgba(255,255,255,0.35)" }}>
                      <span>ETH 60%</span><span>USDC 25%</span><span>ARB 15%</span>
                    </div>
                  </div>
                  <div>
                    <div className="text-[9px] mb-1" style={{ color: "rgba(255,255,255,0.3)" }}>What they see</div>
                    <div className="flex h-2 rounded-full overflow-hidden gap-0.5">
                    ...
                    <div className="flex gap-2 mt-1.5 text-[8px]" style={{ color: "rgba(255,255,255,0.35)" }}>
