...
const testimonials = [
  { quote: "I was on three whale tracker lists. Within a week of running CloakFi, two dropped me. My copy-traders went from 8 to 1.", name: "0xMarc", role: "DeFi trader, $2M+ portfolio", avatar: "M" },
  ...
  { quote: "I built a 200-ETH position over two months. Without CloakFi, every whale tracker would have front-run me. They still think I'm a diversified small-cap holder.", name: "anon_alpha", role: "Smart money trader", avatar: "A" },
];
        ...
        <AnimatedContent distance={40}>
          <div className="mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold tracking-tight max-w-lg text-white">
              Real traders.<br /><span style={{ color: "rgba(255,255,255,0.5)" }}>Real results.</span>
            </h2>
          </div>
        </AnimatedContent>
          ...
          {testimonials.map((t, i) => (
            <AnimatedContent key={i} distance={50} delay={i * 0.15} className={i === 1 ? "md:-mt-6" : ""}>
              <SpotlightCard spotlightColor="rgba(54,144,210,0.06)" className="rounded-2xl p-7 flex flex-col h-full"
                style={{ background: "rgba(20,29,44,0.2)", backdropFilter: "blur(28px)", border: "1px solid rgba(255,255,255,0.12)" } as React.CSSProperties}>
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <p className="text-[15px] leading-relaxed flex-1" style={{ color: "rgba(255,255,255,0.7)" }}>
                    &ldquo;{t.quote}&rdquo;
                  </p>
                  <div className="flex items-center gap-3 mt-6 pt-5" style={{ borderTop: "1px solid rgba(255,255,255,0.1)" }}>
                    ...
                    <div>
                      ...
                      <div className="text-[11px]" style={{ color: "rgba(255,255,255,0.5)" }}>{t.role}</div>
                    </div>
                  </div>
                </div>
              </SpotlightCard>
