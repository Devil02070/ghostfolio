      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
        <AnimatedContent distance={50} duration={0.8}>
          <div className="rounded-3xl p-12 sm:p-16" style={{
            background: "rgba(20,29,44,0.2)",
            backdropFilter: "blur(32px)",
            WebkitBackdropFilter: "blur(32px)",
            border: "1px solid rgba(255,255,255,0.12)",
            boxShadow: "0 24px 64px rgba(0,0,0,0.12), inset 0 1px 0 rgba(255,255,255,0.06)",
          }}>
            ...
            <p className="text-lg max-w-lg mx-auto mb-8 leading-relaxed" style={{ color: "rgba(255,255,255,0.6)" }}>
            ...
            <StarBorder as="div" color="rgba(54,144,210,0.5)" speed="5s" className="inline-flex">
              <button onClick={openLogin} className="flex items-center justify-center gap-3 px-10 py-5 text-base font-semibold text-white rounded-xl group cursor-pointer"
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-6 text-xs" style={{ color: "rgba(255,255,255,0.5)" }}>
